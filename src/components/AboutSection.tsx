          ...
          <FadeIn direction={isRTL ? 'left' : 'right'} delay={0.2} className={cn('relative mt-6 lg:mt-0', isRTL && 'lg:order-1')}>
            <div className="relative">
              ...
              <StaggerContainer className="grid grid-cols-2 gap-3 md:gap-4" staggerDelay={0.1}>
                <StaggerItem>
                  <div className="p-4 md:p-6 bg-card rounded-xl md:rounded-2xl shadow-card hover:shadow-elegant transition-all duration-300 hover:-translate-y-1">
                    <div className="text-2xl md:text-4xl font-display font-bold text-primary mb-1 md:mb-2">15+</div>
                    <div className="text-muted-foreground text-xs md:text-sm">Years Experience</div>
                  </div>
                </StaggerItem>
                <StaggerItem>
                  <div className="p-4 md:p-6 bg-primary rounded-xl md:rounded-2xl shadow-card hover:shadow-elegant transition-all duration-300 hover:-translate-y-1 mt-4 md:mt-8">
                    <div className="text-2xl md:text-4xl font-display font-bold text-primary-foreground mb-1 md:mb-2">50+</div>
                    <div className="text-primary-foreground/80 text-xs md:text-sm">Countries Served</div>
                  </div>
                </StaggerItem>
                <StaggerItem>
                  <div className="p-4 md:p-6 bg-secondary rounded-xl md:rounded-2xl shadow-card hover:shadow-elegant transition-all duration-300 hover:-translate-y-1">
                    <div className="text-2xl md:text-4xl font-display font-bold text-secondary-foreground mb-1 md:mb-2">1000+</div>
                    <div className="text-secondary-foreground/80 text-xs md:text-sm">Happy Clients</div>
                  </div>
                </StaggerItem>
                <StaggerItem>
                  <div className="p-4 md:p-6 bg-accent rounded-xl md:rounded-2xl shadow-card hover:shadow-elegant transition-all duration-300 hover:-translate-y-1 mt-4 md:mt-8">
                    <div className="text-2xl md:text-4xl font-display font-bold text-accent-foreground mb-1 md:mb-2">100%</div>
                    <div className="text-accent-foreground/80 text-xs md:text-sm">Quality Assured</div>
                  </div>
                </StaggerItem>
              </StaggerContainer>
            </div>
